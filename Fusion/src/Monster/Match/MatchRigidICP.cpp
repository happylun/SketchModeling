...
bool MatchRigidICP::initAlignment(
...
bool MatchRigidICP::buildKDTree(
...
bool MatchRigidICP::findNearestNeighbors(
	SKDTree &tree,
...
bool MatchRigidICP::findMatchedNeighbors(
...
bool MatchRigidICP::sliceMatrices(
...
bool MatchRigidICP::extractTransformation(
	Eigen::Matrix3Xd &source,
	Eigen::Matrix3Xd &target,
	Eigen::Affine3d &transformation)
{
